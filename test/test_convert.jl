...
path_out_file_1d_1_x_1 = joinpath(@__DIR__, "data", "rhine_1d_1_x_1.txt")
path_out_file_1d_1_y_1 = joinpath(@__DIR__, "data", "rhine_1d_1_y_1.txt")
path_out_file_1d_1_x_100 = joinpath(@__DIR__, "data", "rhine_1d_1_x_100.txt")
path_out_file_1d_1_y_100 = joinpath(@__DIR__, "data", "rhine_1d_1_y_100.txt")
path_out_file_1d_10_x_1 = joinpath(@__DIR__, "data", "rhine_1d_10_x_1.txt")
path_out_file_1d_10_y_1 = joinpath(@__DIR__, "data", "rhine_1d_10_y_1.txt")
path_out_file_1d_10_x_100 = joinpath(@__DIR__, "data", "rhine_1d_10_x_100.txt")
path_out_file_1d_10_y_100 = joinpath(@__DIR__, "data", "rhine_1d_10_y_100.txt")
path_out_file_2d = joinpath(@__DIR__, "data", "rhine_2d_1.txt")
path_out_file_2d_10 = joinpath(@__DIR__, "data", "rhine_2d_10.txt")
