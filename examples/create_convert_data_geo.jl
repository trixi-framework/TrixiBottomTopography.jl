...
convert_geo_1d(path_src_file, path_out_file_1d_x, nx = nx, ny = ny; excerpt = 20,
               section = 10)
convert_geo_1d(path_src_file, path_out_file_1d_y, nx = nx, ny = ny; excerpt = 20,
               direction = "y", section = 100)
