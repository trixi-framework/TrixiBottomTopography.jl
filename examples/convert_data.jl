...
path_out_file_1d_x = joinpath(@__DIR__, "data", "rhine_data_1d_20_x.txt")
path_out_file_1d_y = joinpath(@__DIR__, "data", "rhine_data_1d_20_y.txt")
path_out_file_2d = joinpath(@__DIR__, "data", "rhine_data_2d_20.txt")
